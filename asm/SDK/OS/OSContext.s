...
/* 8026AC28 00266888  7C B8 E2 A6 */	mfspr r5, HID2
...
/* 8026ADD0 00266A30  7C 78 E2 A6 */	mfspr r3, HID2
...
/* 8026AED4 00266B34  7C 11 E2 A6 */	mfspr r0, GQR1
/* 8026AED8 00266B38  90 03 01 A8 */	stw r0, 0x1a8(r3)
/* 8026AEDC 00266B3C  7C 12 E2 A6 */	mfspr r0, GQR2
/* 8026AEE0 00266B40  90 03 01 AC */	stw r0, 0x1ac(r3)
/* 8026AEE4 00266B44  7C 13 E2 A6 */	mfspr r0, GQR3
/* 8026AEE8 00266B48  90 03 01 B0 */	stw r0, 0x1b0(r3)
/* 8026AEEC 00266B4C  7C 14 E2 A6 */	mfspr r0, GQR4
/* 8026AEF0 00266B50  90 03 01 B4 */	stw r0, 0x1b4(r3)
/* 8026AEF4 00266B54  7C 15 E2 A6 */	mfspr r0, GQR5
/* 8026AEF8 00266B58  90 03 01 B8 */	stw r0, 0x1b8(r3)
/* 8026AEFC 00266B5C  7C 16 E2 A6 */	mfspr r0, GQR6
/* 8026AF00 00266B60  90 03 01 BC */	stw r0, 0x1bc(r3)
/* 8026AF04 00266B64  7C 17 E2 A6 */	mfspr r0, GQR7
...
/* 8026AFA8 00266C08  7C 91 E3 A6 */	mtspr GQR1, r4
/* 8026AFAC 00266C0C  80 83 01 AC */	lwz r4, 0x1ac(r3)
/* 8026AFB0 00266C10  7C 92 E3 A6 */	mtspr GQR2, r4
/* 8026AFB4 00266C14  80 83 01 B0 */	lwz r4, 0x1b0(r3)
/* 8026AFB8 00266C18  7C 93 E3 A6 */	mtspr GQR3, r4
/* 8026AFBC 00266C1C  80 83 01 B4 */	lwz r4, 0x1b4(r3)
/* 8026AFC0 00266C20  7C 94 E3 A6 */	mtspr GQR4, r4
/* 8026AFC4 00266C24  80 83 01 B8 */	lwz r4, 0x1b8(r3)
/* 8026AFC8 00266C28  7C 95 E3 A6 */	mtspr GQR5, r4
/* 8026AFCC 00266C2C  80 83 01 BC */	lwz r4, 0x1bc(r3)
/* 8026AFD0 00266C30  7C 96 E3 A6 */	mtspr GQR6, r4
/* 8026AFD4 00266C34  80 83 01 C0 */	lwz r4, 0x1c0(r3)
/* 8026AFD8 00266C38  7C 97 E3 A6 */	mtspr GQR7, r4
